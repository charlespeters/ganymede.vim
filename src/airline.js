...
" Insert mode
let s:I1 = [ "${uiGroups.gray1}" , "${Ganymede.colors.yellow}", "" , ""  ]
let s:I2 = s:N2
let s:I3 = s:N3
...
" Visual mode
let s:V1 = [ "${uiGroups.gray6}" , "${Ganymede.colors.pink}" , "" , "" ]
let s:V2 = s:N2
let s:V3 = s:N3
...
" Replace mode
let s:R1 = [ "${uiGroups.gray6}" , "${Ganymede.colors.purple}" , "" , "" ]
let s:R2 = s:N2
let s:R3 = s:N3
...
let s:AirlineWarning = [ "${uiGroups.gray6}" , "${Ganymede.colors.orange}" , "" , "" ]
...
let g:airline#themes#ganymede#palette.accents = {'red': [ "${uiGroups.userCurrentState}" , "" , "" , "" ]}
...
let g:airline#themes#ganymede#palette.tabline = {
  \\ 'airline_tab': s:N2,
  \\ 'airline_tabsel': s:N1,
  \\ 'airline_tabtype': [ "${uiGroups.background}" , "${Ganymede.colors.green}" , "" , "" ],
